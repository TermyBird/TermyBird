    ...
    , m_window(window)
{
    ...
    m_dialog = new QMessageBox(QMessageBox::Icon::Warning, "TermyBird", qstring_from_ak_string(message), QMessageBox::StandardButton::Ok, &view());
    ...
    m_dialog = new QMessageBox(QMessageBox::Icon::Question, "TermyBird", qstring_from_ak_string(message), QMessageBox::StandardButton::Ok | QMessageBox::StandardButton::Cancel, &view());
    ...
    dialog.setWindowTitle("TermyBird");

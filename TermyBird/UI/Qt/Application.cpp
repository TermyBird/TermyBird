...
class TermyBirdQApplication : public QApplication {
public:
    explicit TermyBirdQApplication(Main::Arguments& arguments)
...
NonnullOwnPtr<Core::EventLoop> Application::create_platform_event_loop()
{
    if (!browser_options().headless_mode.has_value()) {
        ...
        m_application = make<TermyBirdQApplication>(arguments());
    }
...
{
    QMessageBox::warning(active_tab(), "TermyBird", qstring_from_ak_string(error_message));
}
